...
def main():
    parser = argparse.ArgumentParser(description="Merge multi-source Stage2 json/jsonl into one universal jsonl.")
    ...
    print(f"Saved Stage2 universal input jsonl: {args.output_file}")
