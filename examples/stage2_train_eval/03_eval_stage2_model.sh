#!/bin/bash
# Evaluate a Stage-2 Q-Zoom checkpoint.
...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-${CODE_ROOT}/output/qzoom-qwen2_5vl-7b-K18T3-stage2}"
LOG_SUFFIX_BASE="${LOG_SUFFIX_BASE:-qzoom_stage2}"
NUM_GPUS="${NUM_GPUS:-4}"
